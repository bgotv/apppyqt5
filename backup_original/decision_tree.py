...
class DecisionTree(QObject):
    ...
    def _init_tree(self):
		...
		"dialog_type": "checkbox",
                ...
                "responses": {
                    "default": "campo_crea",
                    "Não foram constatadas divergências": "campo_crea",
                    "Cartão CNPJ não enviado": "campo_crea",
                    "Representante não enviou documentos": "campo_crea",
                    "Nome do representante não consta nos documentos enviados": "campo_crea",
                    "Assinaturas não conferem entre si": "campo_crea"
                },
                ...
                "flag_if_Assinaturas não conferem entre si": 13
            },
            "confere_ata": {
...
#--------------- final comercial---------inicio técnica-----------------------------------------------------------------------------------------------------------------------
            "campo_crea": {
                "action": "show_message",
                "message": "Abra o CREA e clique OK para continuar.",
                "next": "campo_crea_q"
            },
            "campo_crea_q": {
                "question": "A certidão de registro profissional está disponível?",
                "options": ["Sim", "Não"],
                "responses": {
                    "sim": "certidão_crea",
                    "não": "certidão_crea"
            ...
            "certidão_crea": {
                "question": "A certidão de atribuição técnica e TRT/ART apresentada via site de projetos, corresponde ao responsável técnico cadastrado no site ({campo_profissional_site})?",
                "options": ["Sim", "Não"],
                "responses": {
                    "sim": "artigo8_crea",
                    "não": "artigo8_crea"
            ...
            "artigo8_crea": {
                "question": "O profissional tem como atribuição o artigo 8 da resolução 218 do CONFEA/w",
                "options": ["Sim", "Não"],
                "responses": {
            ...
            "campo_profissional_final": {
                "action": "show_message",
                "message": "Abra a ART/TRT e clique OK para prosseguir.",
                "next": "consulta_art"
            },
            "consulta_art": {
                "action": "open_link_crea",
                "message": "Clique em 'ok' para abrir o site do CREA",
                "next": "validade_crea"
            },
            "validade_crea": {
                "question": "Os dados da ART condizem com os dados do site do CREA",
                "options": ["Sim", "Não"],
                "responses": {
                    "sim": "campo_profissional_final_q",
                    "não": "campo_profissional_final_q"
                },
                "flag_if_no": 133
            },
            ...
            "proprietario": {
                "question": "O proprietário da instalação é o mesmo que {proprietario_site}?",
                "options": ["Sim", "Não"],
                "responses": {
                    "sim": "endereco_art",
                    "não": "endereco_art"
            ...
            "campo_atividade_art": {
                "question": "O campo de atividade técnica possui indicação de projeto (elaboração e execução)?",
                "options": ["Sim", "Não"],
                "responses": {
            ...
            "anexoF_tec": {
                "action": "show_message",
                "message": "Abra o anexo F e clique OK para abrir a pasta da nota.",
                "next": "nome_cpf_cliente"
            },
            "nome_cpf_cliente": {
                "question": "O CPF: {NUMERO_DOC} e o Nome: {NOME_RAZAO} do titular da UC estão de acordo com o anexo F",
                "options": ["Sim", "Não"],
                "responses": {
            ...
            "endereco_cliente": {
                "question": "O endereço da instalação é o mesmo de {ENDERECO_COMPLETO}?",
                "options": ["Sim", "Não"],
                "responses": {
                    "sim": "numero_fases",
                    "não": "numero_fases"
            ...
            "numero_fases": {
                "question": "O número de fases é o mesmo que {NUM_FASE} e a corrente nominal do disjuntor é a mesma que {DISJUNTOR}?",
                "options": ["Sim", "Não"],
                "responses": {
                    "sim": "qtd_modulos",
                    "não": "qtd_modulos"
            ...
            "fabricante_modelo_mod": {
                "question": "O modelo dos módulos é mesmos de {modelo_mod_site}?",
                "options": ["Sim", "Não"],
                "responses": {
            ...
            "fabricante_modelo_inv": {
                "question": "O modelo dos inversores é o mesmo de {modelo_inv_site}?",
                "options": ["Sim", "Não"],
                "responses": {
                    "sim": "diagrama_unifilar",
                    "não": "diagrama_unifilar"
                },
                "flag_if_no": 115
            },
            # "menor_potencia": {
            ...
            "diagrama_unifilar": {
                "action": "show_message",
                "message": "Abra o diagrama unifilar e clique OK para seguir.",
                "next": "potencia_total_inversores_unifilar"
            },
            "potencia_total_inversores_unifilar": {
                "question": "A potência total dos módulos e inversores é a mesma do {potencia_total_inv_site}?",
                "options": ["Sim", "Não"],
                "responses": {
                    "sim": "fabricante_modelo_inv_unifilar",
                    "não": "fabricante_modelo_inv_unifilar"
                },
                "flag_if_no": 118
            },
            "fabricante_modelo_inv_unifilar": {
                "question": "O modelo dos inversores é o mesmo de {modelo_inv_site}?",
                "options": ["Sim", "Não"],
                "responses": {
                    "sim": "qtd_inversores_unifilar",
                    "não": "qtd_inversores_unifilar"
                },
                "flag_if_no": 119
            },
            "qtd_inversores_unifilar": {
                "question": "A quantidade de inversores é a mesma de {qnt_inv_site}?",
                "options": ["Sim", "Não"],
                "responses": {
                    "sim": "fabricante_modelo_mod_unifilar",
                    "não": "fabricante_modelo_mod_unifilar"
                },
                "flag_if_no": 120
            },
            "fabricante_modelo_mod_unifilar": {
                "question": "O modelo dos módulos é mesmos de {modelo_mod_site}?",
                "options": ["Sim", "Não"],
                "responses": {
                    "sim": "potencia_total_modulos_unifilar",
                    "não": "potencia_total_modulos_unifilar"
                },
                "flag_if_no": 121
            },
            "potencia_total_modulos_unifilar": {
                "question": "A potência total dos módulos é a mesma do {potencia_total_mod_site}?",
                "options": ["Sim", "Não"],
                "responses": {
                    "sim": "qtd_modulos_unifilar",
                    "não": "qtd_modulos_unifilar"
                },
                "flag_if_no": 127
            },
            "qtd_modulos_unifilar": {
                "question": "A quantidade de módulos é a mesma de {qnt_mod_site}?",
                "options": ["Sim", "Não"],
                "responses": {
                    "sim": "padrao_entrada_unifilar",
                    "não": "padrao_entrada_unifilar"
                },
                "flag_if_no": 128
            },

            "padrao_entrada_unifilar": {
                "question": "O padrão de entrada está de acordo com o informado no anexo F e com o GED?",
                "options": ["Sim", "Não"],
                "responses": {
            ...
            "certificado_inmetro_tec": {
                "action": "open_link",
                "message": "Clique em 'ok' para abrir o site do Inmetro: https://registro.inmetro.gov.br/consulta",
                "next": "declaracao_apresentada"
            },
            ...
            "portaria_tec": {
                "question": "A portaria é 140 ou 150, ou existe o teste de conformidade anexado, ou (caso a potência do inversor seja < 10 kW) a data de concessão é superior a 01/02/2025, ou (caso a potência do inversor seja ≥ 10 kW) a data de concessão é superior a 02/05/2025?",
                "options": ["Sim", "Não"],
                "responses": {
                    "sim": "modelo_inversor",
                    "não": "modelo_inversor"
            ...
            "modelo_inversor": {
                "question": "O modelo do inversor previsto no projeto é igual ao que consta no registro?",
                "options": ["Sim", "Não"],
                "responses": {
                    "sim": "finaliza",
                    "não": "finaliza"
    ...
    def run_tree(self, start_key="tela_aviso"):
        ...
        while current is not None:
            # Inicia medição de etapa: pergunta atual
            metrics_manager.start_stage(self.note_id, f"question_{current}")
            try:
                ...
                if "action" in node:
                    ...
                    elif act == "open_link_crea":
                        QMessageBox.information(self.parent, "Ação", msg)
                        webbrowser.open(settings.SITE_CREA_SP)
                ...
                if node.get("dialog_type") == "checkbox":
                    ...
                    if result != QDialog.Accepted:
                        metrics_manager.end_stage(self.note_id, f"question_{current}")
                        break
                ...
                if current == "modalidade_compensacao":
